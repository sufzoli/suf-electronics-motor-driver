...
// Display port/pin configuration

#define ILI9341_RESET_PORT	P21
#define ILI9341_DC_PORT	P20
#define ILI9341_SPI_PORT 1

#define ILI9341_SPI MACRO_CONCAT2(SPI,ILI9341_SPI_PORT)

#define ILI9341_SPI_CLK_EN MACRO_CONCAT3(SYSCLK_APBCLK_SPI, ILI9341_SPI_PORT, _EN_Msk)

#define ILI9341_SPI_HCLK MACRO_CONCAT3(SYSCLK_CLKSEL1_SPI, ILI9341_SPI_PORT, _HCLK)
