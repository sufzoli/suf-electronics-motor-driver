...
#define PWM_PCR_CH0MOD_ONE_SHOT    (0UL << PWM_PCR_CH0MOD_Pos) /*!< PCR setting for channel 0 Timer one-shot mode */
#define PWM_PCR_CH1MOD_ONE_SHOT    (0UL << PWM_PCR_CH1MOD_Pos) /*!< PCR setting for channel 1 Timer one-shot mode */
#define PWM_PCR_CH2MOD_ONE_SHOT    (0UL << PWM_PCR_CH2MOD_Pos) /*!< PCR setting for channel 2 Timer one-shot mode */
#define PWM_PCR_CH3MOD_ONE_SHOT    (0UL << PWM_PCR_CH3MOD_Pos) /*!< PCR setting for channel 3 Timer one-shot mode */
...
#define PWM_PCR_PWM01TYPE_EDGE_ALIGNED      (0UL << PWM_PCR_PWM01TYPE_Pos) /*!< PCR setting for PWM01 Edge-aligned type */
#define PWM_PCR_PWM01TYPE_CENTER_ALIGNED    (1UL << PWM_PCR_PWM01TYPE_Pos) /*!< PCR setting for PWM01 Center-aligned type*/
#define PWM_PCR_PWM23TYPE_EDGE_ALIGNED      (0UL << PWM_PCR_PWM23TYPE_Pos) /*!< PCR setting for PWM23 Edge-aligned type */
#define PWM_PCR_PWM23TYPE_CENTER_ALIGNED    (1UL << PWM_PCR_PWM23TYPE_Pos) /*!< PCR setting for PWM23 Center-aligned type*/
...
#define PWM_PIER_PWMDIE0_ENABLE  (1UL << PWM_PIER_PWMDIE0_Pos) /*!< PIER setting for channel 0 Timer duty Interrupt Enable */
#define PWM_PIER_PWMDIE1_ENABLE  (1UL << PWM_PIER_PWMDIE1_Pos) /*!< PIER setting for channel 1 Timer duty Interrupt Enable */
#define PWM_PIER_PWMDIE2_ENABLE  (1UL << PWM_PIER_PWMDIE2_Pos) /*!< PIER setting for channel 2 Timer duty Interrupt Enable */
#define PWM_PIER_PWMDIE3_ENABLE  (1UL << PWM_PIER_PWMDIE3_Pos) /*!< PIER setting for channel 3 Timer duty Interrupt Enable */

#define PWM_PIER_INT01TYPE_UNDERFLOW        (0UL << PWM_PIER_INT01TYPE_Pos) /*!< PIER setting for channel 0/1 period interrupt set when counter equals zero*/
#define PWM_PIER_INT01TYPE_MATCH_CNR        (1UL << PWM_PIER_INT01TYPE_Pos) /*!< PIER setting for channel 0/1 period interrupt set when counter equals CNR */

#define PWM_PIER_INT23TYPE_UNDERFLOW        (0UL << PWM_PIER_INT23TYPE_Pos) /*!< PIER setting for channel 2/3 period interrupt set when counter equals zero*/
#define PWM_PIER_INT23TYPE_MATCH_CNR        (1UL << PWM_PIER_INT23TYPE_Pos) /*!< PIER setting for channel 2/3 period interrupt set when counter equals CNR */

#define PWM_PIER_INT01DTYPE_CMRD            (0UL << PWM_PIER_INT01DTYPE_Pos) /*!< PIER setting for channel 0/1 duty interrupt be set when counter equals CMR on down-count*/
#define PWM_PIER_INT01DTYPE_CMRU            (1UL << PWM_PIER_INT01DTYPE_Pos) /*!< PIER setting for channel 0/1 duty interrupt be set when counter equals CMR on up-count */

#define PWM_PIER_INT23DTYPE_CMRD            (0UL << PWM_PIER_INT23DTYPE_Pos) /*!< PIER setting for channel 2/3 duty interrupt be set when counter equals CMR on down-count*/
#define PWM_PIER_INT23DTYPE_CMRU            (1UL << PWM_PIER_INT23DTYPE_Pos) /*!< PIER setting for channel 2/3 duty interrupt be set when counter equals CMR on up-count */
...
/*---------------------------------------------------------------------------------------------------------*/
/*  TCON constants definitions                                                                             */
/*---------------------------------------------------------------------------------------------------------*/
#define PWM_TCON_PWM0TEN_ENABLE  (1UL << PWM_TCON_PWM0TEN_Pos) /*!< TCON setting for enable Channel 0 PWM trigger ADC to start of conversion */
#define PWM_TCON_PWM1TEN_ENABLE  (1UL << PWM_TCON_PWM1TEN_Pos) /*!< TCON setting for enable Channel 1 PWM trigger ADC to start of conversion */
#define PWM_TCON_PWM2TEN_ENABLE  (1UL << PWM_TCON_PWM2TEN_Pos) /*!< TCON setting for enable Channel 2 PWM trigger ADC to start of conversion */
#define PWM_TCON_PWM3TEN_ENABLE  (1UL << PWM_TCON_PWM3TEN_Pos) /*!< TCON setting for enable Channel 3 PWM trigger ADC to start of conversion */

#define PWM_TCON_PWM0DTEN_ENABLE  (1UL << PWM_TCON_PWM0DTEN_Pos) /*!< TCON setting for enable Channel 0 PWM trigger ADC to start of conversion */
#define PWM_TCON_PWM1DTEN_ENABLE  (1UL << PWM_TCON_PWM1DTEN_Pos) /*!< TCON setting for enable Channel 1 PWM trigger ADC to start of conversion */
#define PWM_TCON_PWM2DTEN_ENABLE  (1UL << PWM_TCON_PWM2DTEN_Pos) /*!< TCON setting for enable Channel 2 PWM trigger ADC to start of conversion */
#define PWM_TCON_PWM3DTEN_ENABLE  (1UL << PWM_TCON_PWM3DTEN_Pos) /*!< TCON setting for enable Channel 3 PWM trigger ADC to start of conversion */

/*---------------------------------------------------------------------------------------------------------*/
/*  PSCR constants definitions                                                                             */
/*---------------------------------------------------------------------------------------------------------*/
#define PWM_PSCR_PSSEN0_ENABLE  (1UL << PWM_PSCR_PSSEN0_Pos) /*!< PSCR setting for enable group PWM0 Synchronous Start */
#define PWM_PSCR_PSSEN1_ENABLE  (1UL << PWM_PSCR_PSSEN1_Pos) /*!< PSCR setting for enable group PWM1 Synchronous Start */
#define PWM_PSCR_PSSEN2_ENABLE  (1UL << PWM_PSCR_PSSEN2_Pos) /*!< PSCR setting for enable group PWM2 Synchronous Start */
#define PWM_PSCR_PSSEN3_ENABLE  (1UL << PWM_PSCR_PSSEN3_Pos) /*!< PSCR setting for enable group PWM3 Synchronous Start */
...
/**
 * @brief      Enable PWM output polar inverse for specified channel
 *
 * @param[in]  PWM            PWM group 
 *                            - PWMA : PWM Group A
 *                            - PWMB : PWM Group B 
 ...
 * @return     None
 *
 * @details    This function is used to enable PWM output polar inverse for specified channel
 *
 */
#define _PWM_ENABLE_PWM_POLAR_INV(PWM,u32Ch) (PWM)->PCR|= (PWM_PCR_CH0PINV_Msk<<((u32Ch)*8))



/**
 * @brief      Disable PWM output polar inverse for specified channel
 *
 * @param[in]  PWM            PWM group 
 *                            - PWMA : PWM Group A
 *                            - PWMB : PWM Group B 
 ...
 * @return     None
 *
 * @details    This function is used to disable PWM output polar inverse for specified channel
 *
 */
#define _PWM_DISABLE_PWM_POLAR_INV(PWM,u32Ch) (PWM)->PCR&= ~(PWM_PCR_CH0PINV_Msk<<((u32Ch)*8))
...
/**
 * @brief      Set timer edge-aligned type for specified channel
 *
 * @param[in]  PWM            PWM group 
 *                            - PWMA : PWM Group A
 *                            - PWMB : PWM Group B 
 ...
 * @return     None
 *
 * @details    This function is used to set timer edge-aligned type for specified channel
 *
 *
 */
#define _PWM_SET_TIMER_EDGE_ALIGNED_TYPE(PWM,u32Ch) (PWM)->PCR &= ~(PWM_PCR_PWM01TYPE_Msk<<((u32Ch)/2))




/**
 * @brief      Set timer center-aligned type for specified channel
 *
 * @param[in]  PWM            PWM group 
 *                            - PWMA : PWM Group A
 *                            - PWMB : PWM Group B 
 ...
 * @return     None
 *
 * @details    This function is used to set timer center-aligned type for specified channel
 *
 *
 */
#define _PWM_SET_TIMER_CENTER_ALIGNED_TYPE(PWM,u32Ch) (PWM)->PCR |= (PWM_PCR_PWM01TYPE_Msk<<((u32Ch)/2))
...
/**
 * @brief      Enable timer duty interrupt for specified channel
 *
 * @param[in]  PWM            PWM group 
 *                            - PWMA : PWM Group A
 *                            - PWMB : PWM Group B 
 ...
 * @return     None
 *
 * @details    This function is used to enable timer duty interrupt for specified channel
 *
 */
#define _PWM_ENABLE_TIMER_DUTY_INT(PWM,u32Ch) ((PWM)->PIER|= (PWM_PIER_PWMDIE0_Msk<<(u32Ch)))



/**
 * @brief       Disable timer duty interrupt for specified channel
 *
 * @param[in]  PWM            PWM group 
 *                            - PWMA : PWM Group A
 *                            - PWMB : PWM Group B 
 ...
 * @return     None
 *
 * @details    This function is used to disable timer duty interrupt for specified channel
 *
 */
#define _PWM_DISABLE_TIMER_DUTY_INT(PWM,u32Ch) ((PWM)->PIER &= ~(PWM_PIER_PWMDIE0_Msk<<(u32Ch)))



/**
 * @brief      Set timer interrupt period type interrupt to counter matches to CNR for specified channel
 *
 * @param[in]  PWM            PWM group 
 *                            - PWMA : PWM Group A
 *                            - PWMB : PWM Group B 
 ...
 * @return     None
 *
 * @details    This function is used to set timer interrupt period type interrupt to counter matches to CNR for specified channel
 *
 * @note       This bit is effective when timer in center aligned type only.
 *             
 */
#define _PWM_SET_TIMER_PERIOD_INTTYPE_MATCH_CNR(PWM,u32Ch) ((PWM)->PIER|= (PWM_PIER_INT01TYPE_Msk<<((u32Ch)/2)))




/**
 * @brief      Set timer interrupt period type interrupt to counter underflow for specified channel
 *
 * @param[in]  PWM            PWM group 
 *                            - PWMA : PWM Group A
 *                            - PWMB : PWM Group B 
 ...
 * @details    This function is used to set timer interrupt period type interrupt to counter matches to CNR for specified channel
 *
 * @note       This function is effective when timer in center aligned type only.
 * 
 */
#define _PWM_SET_TIMER_PERIOD_INTTYPE_UNDERFLOW(PWM,u32Ch) ((PWM)->PIER&= ~(PWM_PIER_INT01TYPE_Msk<<((u32Ch)/2)))




/**
 * @brief      Configure system will generate duty interrtup when counter equals to CMR register on down-count for specified channel
 *
 * @param[in]  PWM            PWM group 
 *                            - PWMA : PWM Group A
 *                            - PWMB : PWM Group B 
 ...
 * @return     None
 *
 * @details    This function is used to configure system will generate duty interrtup when counter equals to CMR register on down-count for specified channel
 *
 */
#define _PWM_SET_TIMER_DUTY_INTTYPE_CMRD(PWM,u32Ch) ((PWM)->PIER &= ~(PWM_PIER_INT01DTYPE_Msk<<((u32Ch)/2)))



/**
 * @brief      Configure system will generate duty interrtup when counter equals to CMR register on UP-count for specified channel
 *
 * @param[in]  PWM            PWM group 
 *                            - PWMA : PWM Group A
 *                            - PWMB : PWM Group B 
 ...
 * @return     None
 *
 * @details    This function is used to configure system will generate duty interrtup when counter equals to CMR register on UP-count for specified channel
 *
 */
#define _PWM_SET_TIMER_DUTY_INTTYPE_CMRU(PWM,u32Ch) ((PWM)->PIER |= (PWM_PIER_INT01DTYPE_Msk<<((u32Ch)/2)))
 ...
 *                            - PWM_CH2
 *                            - PWM_CH3      
 * @retval      0             The specified channel timer period interrupt flag is not set 
 * @retval      1             The specified channel timer period interrupt flag is set
 *
...
/**
 * @brief       Get timer duty interrupt flag for specified channel
 *
 * @param[in]  PWM            PWM group 
 *                            - PWMA : PWM Group A
 *                            - PWMB : PWM Group B 
 ...
 *                            - PWM_CH2
 *                            - PWM_CH3      
 * @retval      0             The specified channel timer duty interrupt flag is not set 
 * @retval      1             The specified channel timer duty interrupt flag is set
 *
 * @details    This function is used to get timer duty interrupt flag for specified channel
 *
 */
#define _PWM_GET_TIMER_DUTY_INT_FLAG(PWM,u32Ch) (((PWM)->PIIR&(PWM_PIIR_PWMDIF0_Msk<<(u32Ch)))?1:0)


/**
 * @brief      Clear timer duty interrupt flag for specified channel
 *
 * @param[in]  PWM            PWM group 
 *                            - PWMA : PWM Group A
 *                            - PWMB : PWM Group B 
 ...
 * @return     None
 *
 * @details    This function is used to clear timer duty interrupt flag for specified channel
 *
 */
#define _PWM_CLEAR_TIMER_DUTY_INT_FLAG(PWM,u32Ch) ((PWM)->PIIR = (PWM_PIIR_PWMDIF0_Msk<<(u32Ch)))
 ...
 *
 */
#define _PWM_GET_CAP_INT_FLAG(PWM,u32Ch) (((u32Ch)<2)?(((PWM)->CCR0 >> PWM_CCR0_CAPIF0_Pos >> ((u32Ch)*16)) & 1):(((PWM)->CCR2 >> PWM_CCR2_CAPIF2_Pos >> (((u32Ch)%2)*16)) & 1))
 ...
 *
 */
#define _PWM_GET_CAP_RISING_INDICATOR(PWM,u32Ch) (((u32Ch)<2)?(((PWM)->CCR0 >> PWM_CCR0_CRLRI0_Pos >> ((u32Ch)*16)) & 1):(((PWM)->CCR2 >> PWM_CCR2_CRLRI2_Pos >> (((u32Ch)%2)*16)) & 1))
 ...
 *
 */
#define _PWM_GET_CAP_FALLING_INDICATOR(PWM,u32Ch) (((u32Ch)<2)?(((PWM)->CCR0 >> PWM_CCR0_CFLRI0_Pos >> ((u32Ch)*16)) & 1):(((PWM)->CCR2 >> PWM_CCR2_CFLRI2_Pos >> (((u32Ch)%2)*16)) & 1))
...
/**
 * @brief       Enable timer period trigger ADC function in center-aligned type for specified channel
 *
 * @param[in]   PWM            PWM group 
 *                             - PWMA : PWM Group A
 *                             - PWMB : PWM Group B 
 ...
 * @return      None
 *
 * @details     This function is used to enable PWM period trigger ADC to start of conversion. \n
 *              PWM trigger ADC to start of conversion in edge-aligned mode when counter equals to zero. \n
 *              PWM trigger ADC to start of conversion in center-aligned mode when counter equals to (CNR+1) or zero which depends on INTxxTYPE setting.
 *
 *
 */
#define _PWM_ENABLE_TIMER_PERIOD_TRIG_ADC(PWM,u32Ch) ((PWM)->TCON |= (PWM_TCON_PWM0TEN_Msk<<(u32Ch)))



/**
 * @brief       Disable PWM period trigger ADC to start of conversion
 *
 * @param[in]   PWM            PWM group 
 *                             - PWMA : PWM Group A
 *                             - PWMB : PWM Group B 
 ...
 * @return      None
 *
 * @details     This function is used to disable PWM period trigger ADC to start of conversion. \n
 *
 *
 */
#define _PWM_DISABLE_TIMER_PERIOD_TRIG_ADC(PWM,u32Ch) ((PWM)->TCON &= ~(PWM_TCON_PWM0TEN_Msk<<(u32Ch)))




/**
 * @brief       Enable PWM duty trigger ADC to start of conversion
 *
 * @param[in]   PWM            PWM group 
 *                             - PWMA : PWM Group A
 *                             - PWMB : PWM Group B 
 ...
 * @return      None
 *
 * @details     This function is used to enable PWM duty trigger ADC to start of conversion. \n
 *              PWM trigger ADC to start of conversion in edge-aligned mode when counter equals to CMR. \n
 *              PWM trigger ADC to start of conversion in center-aligned mode when counter equals to CMR on up-count or down-count which depends on INTxxDTYPE setting.
 *
 *
 */
#define _PWM_ENABLE_TIMER_DUTY_TRIG_ADC(PWM,u32Ch) ((PWM)->TCON |= (PWM_TCON_PWM0DTEN_Msk<<(u32Ch)))




/**
 * @brief       Disable PWM duty trigger ADC to start of conversion
 *
 * @param[in]   PWM            PWM group 
 *                             - PWMA : PWM Group A
 *                             - PWMB : PWM Group B 
 ...
 * @return      None
 *
 * @details     This function is used to disable PWM duty trigger ADC to start of conversion. \n
 *
 *
 */
#define _PWM_DISABLE_TIMER_DUTY_TRIG_ADC(PWM,u32Ch) ((PWM)->TCON &= ~(PWM_TCON_PWM0DTEN_Msk<<(u32Ch)))




/**
 * @brief       Get PWM trigger ADC to start of conversion flag for specified channel
 *
 * @param[in]  PWM            PWM group 
 *                            - PWMA : PWM Group A
 *                            - PWMB : PWM Group B 
 ...
 *
 */
#define _PWM_GET_TIMER_TRIG_ADC_FLAG(PWM,u32Ch) (((PWM)->TSTATUS&(PWM_TSTATUS_PWM0TF_Msk<<(u32Ch)))?1:0)



/**
 * @brief      Clear timer trigger ADC to start conversion flag interrupt flag
 *
 * @param[in]  PWM            PWM group 
 *                            - PWMA : PWM Group A
 *                            - PWMB : PWM Group B 
 ...
 * @return     None
 *
 * @details    This function is used to clear timer trigger ADC to start conversion flag interrupt flag
 *
 */
#define _PWM_CLEAR_TIMER_TRIG_ADC_FLAG(PWM,u32Ch) ((PWM)->TSTATUS = (PWM_TSTATUS_PWM0TF_Msk<<(u32Ch)))




/**
 * @brief       Enable timer synchronous start
 *
 * @param[in]   PWM            PWM group 
 *                             - PWMA : PWM Group A
 *                             - PWMB : PWM Group B 
 ...
 * @return      None
 *
 * @details     This function is used to enable timer synchronous start.
 *
 *
 */
#define _PWM_ENABLE_TIMER_SYNC_START(PWM,u32Ch) ((PWM)->PSCR |= (PWM_PSCR_PSSEN0_Msk<<((u32Ch) * 8)))




/**
 * @brief       Disable timer synchronous start
 *
 * @param[in]   PWM            PWM group 
 *                             - PWMA : PWM Group A
 *                             - PWMB : PWM Group B 
 ...
 * @return      None
 *
 * @details     This function is used to disable timer synchronous start.
 *
 *
 */
#define _PWM_DISABLE_TIMER_SYNC_START(PWM,u32Ch) ((PWM)->PSCR &= ~(PWM_PSCR_PSSEN0_Msk<<((u32Ch) * 8)))
 ...
 */ 
extern __inline void PWM_ResetPwmController(PWM_T* PWM)
{
 ...
 */
extern __inline uint32_t PWM_GetTimerClockSource(PWM_T* PWM, uint32_t u32Ch)
{
    uint8_t     u8EngineClk;
    uint32_t u32ClkTbl[4] = {__XTAL, __IRC10K, 0, __IRC22M};
