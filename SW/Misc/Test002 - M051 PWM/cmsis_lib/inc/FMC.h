 ...
 * 
 * @param[in]   u32MapAddr  The page address to remap to addrss 0x0. The address must be page alignment.
 *
 ...
 *
 */
static __INLINE void FMC_SetVECMAP(uint32_t u32MapAddr)
{ 
    FMC->ISPCMD = FMC_ISPCMD_VECMAP;
    FMC->ISPADR = u32MapAddr;
    FMC->ISPTRG = 0x1;
    __ISB();
    while (FMC->ISPTRG);
}
