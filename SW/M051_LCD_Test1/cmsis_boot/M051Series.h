...
typedef struct
{
     ...
     * |        |          |0 = The ACMP0_N pin is selected as the source of negative comparator input.
     ...
     * CR1
     * ===================================================================================================
     * Offset: 0x04  ACMP Comparator Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |ACMPEN    |Comparator Enable
     ...
     * |[4]     |NEGSEL     |Comparator negative input selection
     * |        |          |1 = The internal band-gap reference voltage is selected as the source of negative comparator input.
     * |        |          |0 = The ACMP1_N pin is selected as the source of negative comparator input.
     * |[6]     |ACMPOINV  |Comparator output inverse select
     * |        |          |1 = The comparator output inverse function Enabled.
     * |        |          |0 = The comparator output inverse function Disabled
     */    
     ...
     * |[1]     |ACMPF1    |Comparator Flag 1
     * |        |          |This bit is set by hardware whenever the comparator output changes state. This will cause an interrupt if ACMPIE is set to 1.
     * |        |          |Write 1 to clear this bit to zero.
     * |[2]     |ACMPO0    |Comparator 0 Output
     * |        |          |Synchronized to the APB clock to allow reading by software. Cleared when the comparator is disabled (ACMP_CR0[0] = 0).
     * |[3]     |ACMPO1    |Comparator 1 Output
     * |        |          |Synchronized to the APB clock to allow reading by software. Cleared when the comparator is disabled (ACMP_CR1[0] = 0).
     */    
        __IO uint32_t SR01;
...
typedef struct
{
     ...
     * |[4]     |NEGSEL     |Comparator negative input selection
     * |        |          |1 = The internal band-gap reference voltage is selected as the source of negative comparator input.
     * |        |          |0 = The ACMP2_N pin is selected as the source of negative comparator input.
     * |[6]     |ACMPOINV  |Comparator output inverse select
     * |        |          |1 = The comparator output inverse function Enabled.
     * |        |          |0 = The comparator output inverse function Disabled
     */    
     ...
     * |[4]     |NEGSEL     |Comparator negative input selection
     * |        |          |1 = The internal band-gap reference voltage is selected as the source of negative comparator input.
     * |        |          |0 = The ACMP3_N pin is selected as the source of negative comparator input.
     * |[6]     |ACMPOINV  |Comparator output inverse select
     * |        |          |1 = The comparator output inverse function Enabled.
     * |        |          |0 = The comparator output inverse function Disabled
     */    
     ...
     * Offset: 0x08  ACMP Comparator Status Register
     * ---------------------------------------------------------------------------------------------------
     * |[0]     |ACMPF2    |Comparator 2 Flag
     * |        |          |This bit is set by hardware whenever the comparator output changes state. This will cause an interrupt if ACMPIE is set to 1.
     * |        |          |Write 1 to clear this bit to zero.
     * |[1]     |ACMPF3    |Comparator 3 Flag
     * |        |          |This bit is set by hardware whenever the comparator output changes state. This will cause an interrupt if ACMPIE is set to 1.
     * |        |          |Write 1 to clear this bit to zero.
     * |[2]     |ACMPO2    |Comparator 2 Output
     * |        |          |Synchronized to the APB clock to allow reading by software. Cleared when the comparator is disabled (ACMP_CR2[0] = 0).
     * |[3]     |ACMPO3    |Comparator 3 Output
     * |        |          |Synchronized to the APB clock to allow reading by software. Cleared when the comparator is disabled (ACMP_CR3[0] = 0).
     */    
        __IO uint32_t SR23;
...
#define ACMP_SR01_ACMPO1_Pos   3                                 /*!< ACMP SR01: ACMPO1 Position */
#define ACMP_SR01_ACMPO1_Msk   (1ul << ACMP_SR01_ACMPO1_Pos)     /*!< ACMP SR01: ACMPO1 Mask */

#define ACMP_SR01_ACMPO0_Pos   2                                 /*!< ACMP SR01: ACMPO0 Position */
#define ACMP_SR01_ACMPO0_Msk   (1ul << ACMP_SR01_ACMPO0_Pos)     /*!< ACMP SR01: ACMPO0 Mask */

#define ACMP_SR01_ACMPF1_Pos   1                                 /*!< ACMP SR01: ACMPF1 Position */
#define ACMP_SR01_ACMPF1_Msk   (1ul << ACMP_SR01_ACMPF1_Pos)     /*!< ACMP SR01: ACMPF1 Mask */

#define ACMP_SR01_ACMPF0_Pos   0                                 /*!< ACMP SR01: ACMPF0 Position */
#define ACMP_SR01_ACMPF0_Msk   (1ul << ACMP_SR01_ACMPF0_Pos)     /*!< ACMP SR01: ACMPF0 Mask */

/* ACMP_SR23 Bit Field Definitions */
#define ACMP_SR23_ACMPO3_Pos   3                                 /*!< ACMP SR23: ACMPO3 Position */
#define ACMP_SR23_ACMPO3_Msk   (1ul << ACMP_SR23_ACMPO3_Pos)     /*!< ACMP SR23: ACMPO3 Mask */

#define ACMP_SR23_ACMPO2_Pos   2                                 /*!< ACMP SR23: ACMPO2 Position */
#define ACMP_SR23_ACMPO2_Msk   (1ul << ACMP_SR23_ACMPO2_Pos)     /*!< ACMP SR23: ACMPO2 Mask */

#define ACMP_SR23_ACMPF3_Pos   1                                 /*!< ACMP SR23: ACMPF3 Position */
#define ACMP_SR23_ACMPF3_Msk   (1ul << ACMP_SR23_ACMPF3_Pos)     /*!< ACMP SR23: ACMPF3 Mask */

#define ACMP_SR23_ACMPF2_Pos   0                                 /*!< ACMP SR23: ACMPF2 Position */
#define ACMP_SR23_ACMPF2_Msk   (1ul << ACMP_SR23_ACMPF2_Pos)     /*!< ACMP SR23: ACMPF2 Mask */
...
/*----------------------- Divider Interface Controller ------------------*/
/** @addtogroup M051_DIV M051 Divider
  Memory Mapped Structure for M051 Series Divider Interface Controller
  @{
 */
typedef struct
{
...
#define DIV_DIVSTS_DIV_FINISH_Pos   0
#define DIV_DIVSTS_DIV_FINISH_Msk   (1ul << DIV_DIVSTS_DIV_FINISH_Pos)

#define DIV_DIVSTS_DIV0_Pos         1
#define DIV_DIVSTS_DIV0_Msk         (1ul << DIV_DIVSTS_DIV0_Pos)
...
#define SYS_IPRSTC1_DIV_RST_Pos                 4                                       /*!< GCR IPRSTC1: DIV_RST Position */
#define SYS_IPRSTC1_DIV_RST_Msk                 (1ul << SYS_IPRSTC1_DIV_RST_Pos)        /*!< GCR IPRSTC1: DIV_RST Mask */
...
#define SYSCLK_AHBCLK_DIV_EN_Pos                4                                       /*!< SYSCLK AHBCLK: DIV_EN Position */
#define SYSCLK_AHBCLK_DIV_EN_Msk                (1ul << SYSCLK_AHBCLK_DIV_EN_Pos)       /*!< SYSCLK AHBCLK: DIV_EN Mask */
...
#define SYSCLK_APBCLK_ACMP23_EN_Pos             31                                      /*!< SYSCLK APBCLK: ACMP23_EN Position */
#define SYSCLK_APBCLK_ACMP23_EN_Msk             (1ul << SYSCLK_APBCLK_ACMP23_EN_Pos)    /*!< SYSCLK APBCLK: ACMP23_EN Mask */

#define SYSCLK_APBCLK_ACMP01_EN_Pos             30                                      /*!< SYSCLK APBCLK: ACMP01_EN Position */
#define SYSCLK_APBCLK_ACMP01_EN_Msk             (1ul << SYSCLK_APBCLK_ACMP01_EN_Pos)    /*!< SYSCLK APBCLK: ACMP01_EN Mask */
...
#define SYSCLK_FRQDIV_DIVIDER1_Pos              5                                       /*!< SYSCLK FRQDIV: DIVIDER1 Position */
#define SYSCLK_FRQDIV_DIVIDER1_Msk              (1ul << SYSCLK_FRQDIV_DIVIDER1_Pos)     /*!< SYSCLK FRQDIV: DIVIDER1 Mask */
...
#define DIV_BASE            (AHB_BASE       + 0x14000)                  /*!< DIV Base Address                                 */
...
#define ACMP01              ((ACMP01_T *) ACMP01_BASE)                  /*!< ACMP01 Configuration Struct                      */
#define ACMP23              ((ACMP23_T *) ACMP23_BASE)                  /*!< ACMP23 Configuration Struct                      */
...
#define DIV                 ((DIV_T *) DIV_BASE)                        /*!< DIV Configuration Struct                         */
